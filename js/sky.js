...
AFRAME.registerComponent('sky', {
    ...
    tick: function (time) {
        ...
        boatA.setAttribute("position", "0 " + ((avg / 40)+0.0) + " 0");
        camera.setAttribute("user-height", ((avg / 50)+1.5));
        ...
        //console.log(round(avg*3.5, 0))
        
        $("#sky").attr("color", "rgb(" + round(avg*3.5, 0) + ", 60, 136)")
